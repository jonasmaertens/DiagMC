...
area_method(int(1e8), plot=True)
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{images/area_method_convergence2.png}
  \end{figure}
\end{frame}
...
mc_integrate(int(1e8), plot=True)
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{images/mc_integration_method_convergence2.png}
  \end{figure}
\end{frame}
